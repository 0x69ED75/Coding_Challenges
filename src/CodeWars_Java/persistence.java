...
/*
Return the multiplicative CodeWars_Java.persistence of a given number.
multiplicative CodeWars_Java.persistence is the number of times you must multiply the digits in num until you reach a single digit.
