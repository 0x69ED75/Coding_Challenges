...
public class sentenceOrder {
    ...
    public static String order(String words) {
        ...
        ArrayList<String> str = new ArrayList (Collections.nCopies (arr.length, null)); // creating an empty arraylist which is the CodeWars_Java.same size as 'arr', temporarily occupied by nulls.
